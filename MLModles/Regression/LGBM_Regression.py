...
def optimize_lightgbm(X_train, y_train, X_test, y_test, n_combinations=500):
    print("\n=== LightGBM Model Hyperparameter Optimization ===")
...
best_lgb_model, lgb_pred, lgb_mse, lgb_r2, best_params = optimize_lightgbm(X_train, y_train, X_test, y_test,
                                                                            n_combinations=200)

print(f"\nFinal Testing Set R² for the Best Model: {lgb_r2:.4f}")
