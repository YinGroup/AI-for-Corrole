...
def optimize_decision_tree(X_train, y_train, X_test, y_test, n_combinations=200):
...
best_dt_model, dt_pred, dt_mse, dt_r2, best_params = optimize_decision_tree(X_train, y_train, X_test, y_test,
                                                                            n_combinations=200)

print(f"\nFinal Testing Set R² for the Best Model: {dt_r2:.4f}")
