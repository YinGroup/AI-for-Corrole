...
def optimize_et(X_train, y_train, X_test, y_test, n_combinations=500):
    print("\n=== Extra Trees Model Hyperparameter Optimization ===")
    ...
    param_grid = {
        ...
        # 'auto' replaced with 'sqrt' to avoid deprecation warning
    ...
    base_combinations = [
        # Base combo 1: Medium estimators, medium depth
        {
            'n_estimators': 200,
            'max_depth': 5,
            'min_samples_split': 2,
            'min_samples_leaf': 1,
            'max_features': 'sqrt' # Replaced 'auto'
        },
        # Base combo 2: More estimators, shallow tree
        {
            'n_estimators': 300,
            'max_depth': 3,
            'min_samples_split': 5,
        ...
        # Base combo 3: Fewer estimators, deep tree
        {
            'n_estimators': 100,
            'max_depth': 7,
...
# Train and optimize the Extra Trees model
best_et_model, et_pred, et_mse, et_r2, best_params = optimize_et(X_train, y_train, X_test, y_test, n_combinations=200)

print(f"\nFinal Testing Set R² for the Best Model: {et_r2:.4f}")
