...
def optimize_random_forest(X_train, y_train, X_test, y_test, n_combinations=200):
    ...
    base_combinations = [
        ...
        # Base combo 3: Medium estimators, deep tree
        {
            'n_estimators': 200,
            'max_depth': 7,
...
best_rf_model, rf_pred, rf_mse, rf_r2, best_params = optimize_random_forest(
    X_train, y_train, X_test, y_test, n_combinations=200
)

print(f"\nFinal Testing Set R² for the Best Model: {rf_r2:.4f}")
